              ...
              child: InnerShadowContainer(
                ...
                child: Theme(
                  ...
                  child: Material(
                      ...
                      children: [
                        Text(
                          index == 0 && widget.selectedFiltersCount > 0
                              ...
                              : filters[index],
                          style: textStyle_14MediumGreyHintStyle().copyWith(color: Colors.black,fontWeight: FontWeight.w500),
                        ),
                           if (isSelected) ...[
                          SizedBox(width: 4.w),
                    ...
                    labelStyle: textStyle_14MediumGreyHintStyle().copyWith(color: Colors.black,fontWeight: FontWeight.w500),
